 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ee=gs;function $i(t,e={}){let i=t;typeof e!="object"&&(e={name:e});const n={name:ft,automaticDataCollectionEnabled:!0,...e},r=n.name;if(typeof r!="string"||!r)throw J.create("bad-app-name",{appName:String(r)});if(i||(i=Ai()),!i)throw J.create("no-options");const s=$e.get(r);if(s){if(ie(i,s.options)&&ie(n,s.config))return s;throw J.create("duplicate-app",{appName:r})}const a=new Tr(r);for(const l of gt.values())a.addComponent(l);const c=new bs(i,n,a);return $e.set(r,c),c}function Ui(t=ft){const e=$e.get(t);if(!e&&t===ft&&Ai())return $i();if(!e)throw J.create("no-app",{appName:t});return e}function L(t,e,i){let n=ms[t]??t;i&&(n+=`-${i}`);const r=n.match(/\s|\//),s=e.match(/\s|\//);if(r||s){const a=[`Unable to register library "${n}" with version "${e}":`];r&&a.push(`library name "${n}" contains illegal characters (whitespace or "/")`),r&&s&&a.push("and"),s&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),q.warn(a.join(" "));return}B(new z(`${n}-version`,()=>({library:n,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ws="firebase-heartbeat-database",xs=1,ke="firebase-heartbeat-store";let nt=null;function qi(){return nt||(nt=Mi(ws,xs,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(ke)}catch(i){console.warn(i)}}}}).catch(t=>{throw J.create("idb-open",{originalErrorMessage:t.message})})),nt}async function ks(t){try{const i=(await qi()).transaction(ke),n=await i.objectStore(ke).get(Bi(t));return await i.done,n}catch(e){if(e instanceof N)q.warn(e.message);else{const i=J.create("idb-get",{originalErrorMessage:e?.message});q.warn(i.message)}}}async function Gt(t,e){try{const n=(await qi()).transaction(ke,"readwrite");await n.objectStore(ke).put(e,Bi(t)),await n.done}catch(i){if(i instanceof N)q.warn(i.message);else{const n=J.create("idb-set",{originalErrorMessage:i?.message});q.warn(n.message)}}}function Bi(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zi=new Map;function en(t,e){const i=Ge(t);tn(i,e),Hs(i,e)}function tn(t,e){const i=Zi.get(t);if(i)for(const n of i)n(e)}function Hs(t,e){const i=Vs();i&&i.postMessage({key:t,fid:e}),Gs()}let ee=null;function Vs(){return!ee&&"BroadcastChannel"in self&&(ee=new BroadcastChannel("[Firebase] FID Change"),ee.onmessage=t=>{tn(t.data.key,t.data.fid)}),ee}function Gs(){Zi.size===0&&ee&&(ee.close(),ee=null)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ks="firebase-installations-database",Ys=1,re="firebase-installations-store";let rt=null;function Tt(){return rt||(rt=Mi(Ks,Ys,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(re)}}})),rt}async function Ue(t,e){const i=Ge(t),r=(await Tt()).transaction(re,"readwrite"),s=r.objectStore(re),a=await s.get(i);return await s.put(e,i),await r.done,(!a||a.fid!==e.fid)&&en(t,e.fid),e}async function nn(t){const e=Ge(t),n=(await Tt()).transaction(re,"readwrite");await n.objectStore(re).delete(e),await n.done}async function Ke(t,e){const i=Ge(t),r=(await Tt()).transaction(re,"readwrite"),s=r.objectStore(re),a=await s.get(i),c=e(a);return c===void 0?await s.delete(i):await s.put(c,i),await r.done,c&&(!a||a.fid!==c.fid)&&en(t,c.fid),c}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const qe="analytics",va="firebase_id",ya="origin",ba=60*1e3,wa="https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig",At="https://www.googletagmanager.com/gtag/js";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wa{constructor(e){this.app=e}_delete(){return delete de[this.app.options.appId],Promise.resolve()}}let de={},Qt=[];const Zt={};let at="dataLayer",Ha="gtag",ei,Ct,ti=!1;function Va(){const t=[];if(Li()&&t.push("This is a browser extension environment."),dr()||t.push("Cookies are not available."),t.length>0){const e=t.map((n,r)=>`(${r+1}) ${n}`).join(" "),i=S.create("invalid-analytics-context",{errorInfo:e});I.warn(i.message)}}function Ga(t,e,i){Va();const n=t.options.appId;if(!n)throw S.create("no-app-id");if(!t.options.apiKey)if(t.options.measurementId)I.warn(`The "apiKey" field is empty in the local Firebase config. This is needed to fetch the latest measurement ID for this Firebase app. Falling back to the measurement ID ${t.options.measurementId} provided in the "measurementId" field in the local Firebase config.`);else throw S.create("no-api-key");if(de[n]!=null)throw S.create("already-exists",{id:n});if(!ti){Ea(at);const{wrappedGtag:s,gtagCore:a}=Aa(de,Qt,Zt,at,Ha);Ct=s,ei=a,ti=!0}return de[n]=ja(t,Qt,Zt,e,ei,at,i),new Wa(t)}function Ka(t=Ui()){t=P(t);const e=ge(t,qe);return e.isInitialized()?e.getImmediate():Ya(t)}function Ya(t,e={}){const i=ge(t,qe);if(i.isInitialized()){const r=i.getImmediate();if(ie(e,i.getOptions()))return r;throw S.create("already-initialized")}return i.initialize({options:e})}function Xa(t,e,i){t=P(t),Ba(Ct,de[t.app.options.appId],e,i).catch(n=>I.error(n))}function Ja(t,e,i,n){t=P(t),qa(Ct,de[t.app.options.appId],e,i,n).catch(r=>I.error(r))}const ii="@firebase/analytics",ni="0.10.22";function Qa(){B(new z(qe,(e,{options:i})=>{const n=e.getProvider("app").getImmediate(),r=e.getProvider("installations-internal").getImmediate();return Ga(n,r,i)},"PUBLIC")),B(new z("analytics-internal",t,"PRIVATE")),L(ii,ni),L(ii,ni,"esm2020");function t(e){try{const i=e.getProvider(qe).getImmediate();return{logEvent:(n,r,s)=>Ja(i,n,r,s),setUserProperties:(n,r)=>Xa(i,n,r)}}catch(i){throw S.create("interop-component-reg-failed",{reason:i})}}}Qa();function dn(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const Za=dn,un=new oe("auth","Firebase",dn());/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Be=new It("@firebase/auth");function eo(t,...e){Be.logLevel<=m.WARN&&Be.warn(`Auth (${Ee}): ${t}`,...e)}function Oe(t,...e){Be.logLevel<=m.ERROR&&Be.error(`Auth (${Ee}): ${t}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Te{constructor(e,i){this.shortDelay=e,this.longDelay=i,F(i>e,"Short delay should be less than long delay!"),this.isMobile=ar()||cr()}get(){return io()?this.isMobile?this.longDelay:this.shortDelay:Math.min(5e3,this.shortDelay)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const so=["/v1/accounts:signInWithCustomToken","/v1/accounts:signInWithEmailLink","/v1/accounts:signInWithIdp","/v1/accounts:signInWithPassword","/v1/accounts:signInWithPhoneNumber","/v1/token"],ao=new Te(3e4,6e4);function Q(t,e){return t.tenantId&&!e.tenantId?{...e,tenantId:t.tenantId}:e}async function j(t,e,i,n,r={}){return fn(t,r,async()=>{let s={},a={};n&&(e==="GET"?a=n:s={body:JSON.stringify(n)});const c=_e({...a,key:t.config.apiKey}).slice(1),l=await t._getAdditionalHeaders();l["Content-Type"]="application/json",t.languageCode&&(l["X-Firebase-Locale"]=t.languageCode);const d={method:e,headers:l,...s};return or()||(d.referrerPolicy="strict-origin-when-cross-origin"),t.emulatorConfig&&kt(t.emulatorConfig.host)&&(d.credentials="include"),hn.fetch()(await gn(t,t.config.apiHost,i,c),d)})}async function fn(t,e,i){t._canInitEmulator=!1;const n={...ro,...e};try{const r=new co(t),s=await Promise.race([i(),r.promise]);r.clearNetworkTimeout();const a=await s.json();if("needConfirmation"in a)throw Ce(t,"account-exists-with-different-credential",a);if(s.ok&&!("errorMessage"in a))return a;{const c=s.ok?a.errorMessage:a.error.message,[l,d]=c.split(" : ");if(l==="FEDERATED_USER_ID_ALREADY_LINKED")throw Ce(t,"credential-already-in-use",a);if(l==="EMAIL_EXISTS")throw Ce(t,"email-already-in-use",a);if(l==="USER_DISABLED")throw Ce(t,"user-disabled",a);const g=n[l]||l.toLowerCase().replace(/[_\s]+/g,"-");if(d)throw pn(t,g,d);R(t,g)}}catch(r){if(r instanceof N)throw r;R(t,"network-request-failed",{message:String(r)})}}async function Se(t,e,i,n,r={}){const s=await j(t,e,i,n,r);return"mfaPendingCredential"in s&&R(t,"multi-factor-auth-required",{_serverResponse:s}),s}async function gn(t,e,i,n){const r=`${e}${i}?${n}`,s=t,a=s.config.emulator?Lt(t.config,r):`${t.config.apiScheme}://${r}`;return so.includes(i)&&(await s._persistenceManagerAvailable,s._getPersistenceType()==="COOKIE")?s._getPersistence()._getFinalTarget(a).toString():a}function oo(t){switch(t){case"ENFORCE":return"ENFORCE";case"AUDIT":return"AUDIT";case"OFF":return"OFF";default:return"ENFORCEMENT_STATE_UNSPECIFIED"}}class co{clearNetworkTimeout(){clearTimeout(this.timer)}constructor(e){this.auth=e,this.timer=null,this.promise=new Promise((i,n)=>{this.timer=setTimeout(()=>n(D(this.auth,"network-request-failed")),ao.get())})}}function Ce(t,e,i){const n={appName:t.name};i.email&&(n.email=i.email),i.phoneNumber&&(n.phoneNumber=i.phoneNumber);const r=D(t,e,n);return r.customData._tokenResponse=i,r}function si(t){return t!==void 0&&t.enterprise!==void 0}class lo{constructor(e){if(this.siteKey="",this.recaptchaEnforcementState=[],e.recaptchaKey===void 0)throw new Error("recaptchaKey undefined");this.siteKey=e.recaptchaKey.split("/")[3],this.recaptchaEnforcementState=e.recaptchaEnforcementState}getProviderEnforcementState(e){if(!this.recaptchaEnforcementState||this.recaptchaEnforcementState.length===0)return null;for(const i of this.recaptchaEnforcementState)if(i.provider&&i.provider===e)return oo(i.enforcementState);return null}isProviderEnabled(e){return this.getProviderEnforcementState(e)==="ENFORCE"||this.getProviderEnforcementState(e)==="AUDIT"}isAnyProviderEnabled(){return this.isProviderEnabled("EMAIL_PASSWORD_PROVIDER")||this.isProviderEnabled("PHONE_PROVIDER")}}async function uo(t,e){return j(t,"GET","/v2/recaptchaConfig",Q(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function po(t,e){return j(t,"POST","/v1/accounts:delete",e)}async function Fe(t,e){return j(t,"POST","/v1/accounts:lookup",e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function we(t){if(t)try{const e=new Date(Number(t));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function ho(t,e=!1){const i=P(t),n=await i.getIdToken(e),r=Dt(n);f(r&&r.exp&&r.auth_time&&r.iat,i.auth,"internal-error");const s=typeof r.firebase=="object"?r.firebase:void 0,a=s?.sign_in_provider;return{claims:r,token:n,authTime:we(ot(r.auth_time)),issuedAtTime:we(ot(r.iat)),expirationTime:we(ot(r.exp)),signInProvider:a||null,signInSecondFactor:s?.sign_in_second_factor||null}}function ot(t){return Number(t)*1e3}function Dt(t){const[e,i,n]=t.split(".");if(e===void 0||i===void 0||n===void 0)return Oe("JWT malformed, contained fewer than 3 sections"),null;try{const r=Pi(i);return r?JSON.parse(r):(Oe("Failed to decode base64 JWT payload"),null)}catch(r){return Oe("Caught error parsing JWT payload as JSON",r?.toString()),null}}function ai(t){const e=Dt(t);return f(e,"internal-error"),f(typeof e.exp<"u","internal-error"),f(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function yo(t,e){const i=await fn(t,{},async()=>{const n=_e({grant_type:"refresh_token",refresh_token:e}).slice(1),{tokenApiHost:r,apiKey:s}=t.config,a=await gn(t,r,"/v1/token",`key=${s}`),c=await t._getAdditionalHeaders();c["Content-Type"]="application/x-www-form-urlencoded";const l={method:"POST",headers:c,body:n};return t.emulatorConfig&&kt(t.emulatorConfig.host)&&(l.credentials="include"),hn.fetch()(a,l)});return{accessToken:i.access_token,expiresIn:i.expires_in,refreshToken:i.refresh_token}}async function bo(t,e){return j(t,"POST","/v2/accounts:revokeToken",Q(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ze(t,e,i){return`firebase:${t}:${e}:${i}`}class pe{constructor(e,i,n){this.persistence=e,this.auth=i,this.userKey=n;const{config:r,name:s}=this.auth;this.fullUserKey=ze(this.userKey,r.apiKey,s),this.fullPersistenceKey=ze("persistence",r.apiKey,s),this.boundEventHandler=i._onStorageEvent.bind(i),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);if(!e)return null;if(typeof e=="string"){const i=await Fe(this.auth,{idToken:e}).catch(()=>{});return i?C._fromGetAccountInfoResponse(this.auth,i,e):null}return C._fromJSON(this.auth,e)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const i=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,i)return this.setCurrentUser(i)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,i,n="authUser"){if(!i.length)return new pe($(ci),e,n);const r=(await Promise.all(i.map(async d=>{if(await d._isAvailable())return d}))).filter(d=>d);let s=r[0]||$(ci);const a=ze(n,e.config.apiKey,e.name);let c=null;for(const d of i)try{const g=await d._get(a);if(g){let u;if(typeof g=="string"){const h=await Fe(e,{idToken:g}).catch(()=>{});if(!h)break;u=await C._fromGetAccountInfoResponse(e,h,g)}else u=C._fromJSON(e,g);d!==s&&(c=u),s=d;break}}catch{}const l=r.filter(d=>d._shouldAllowMigration);return!s._shouldAllowMigration||!l.length?new pe(s,e,n):(s=l[0],c&&await s._set(a,c.toJSON()),await Promise.all(i.map(async d=>{if(d!==s)try{await d._remove(a)}catch{}})),new pe(s,e,n))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tn(t,e=[]){let i;switch(t){case"Browser":i=li(_());break;case"Worker":i=`${li(_())}-${t}`;break;default:i=t}const n=e.length?e.join(","):"FirebaseCore-web";return`${i}/JsCore/${Ee}/${n}`}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function qo(t,e){return Se(t,"POST","/v1/accounts:signInWithPassword",Q(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Bo(t,e){return Se(t,"POST","/v1/accounts:signInWithEmailLink",Q(t,e))}async function Fo(t,e){return Se(t,"POST","/v1/accounts:signInWithEmailLink",Q(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function he(t,e){return Se(t,"POST","/v1/accounts:signInWithIdp",Q(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wo(t){switch(t){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}function Ho(t){const e=ye(be(t)).link,i=e?ye(be(e)).deep_link_id:null,n=ye(be(t)).deep_link_id;return(n?ye(be(n)).link:null)||n||i||e||t}class Nt{constructor(e){const i=ye(be(e)),n=i.apiKey??null,r=i.oobCode??null,s=Wo(i.mode??null);f(n&&r&&s,"argument-error"),this.apiKey=n,this.operation=s,this.code=r,this.continueUrl=i.continueUrl??null,this.languageCode=i.lang??null,this.tenantId=i.tenantId??null}static parseLink(e){const i=Ho(e);try{return new Nt(i)}catch{return null}}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class me{constructor(){this.providerId=me.PROVIDER_ID}static credential(e,i){return Ie._fromEmailAndPassword(e,i)}static credentialWithLink(e,i){const n=Nt.parseLink(i);return f(n,"argument-error"),Ie._fromEmailAndCode(e,n.code,n.tenantId)}}me.PROVIDER_ID="password";me.EMAIL_PASSWORD_SIGN_IN_METHOD="password";me.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class K extends Pe{constructor(){super("github.com")}static credential(e){return se._fromParams({providerId:K.PROVIDER_ID,signInMethod:K.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return K.credentialFromTaggedObject(e)}static credentialFromError(e){return K.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return K.credential(e.oauthAccessToken)}catch{return null}}}K.GITHUB_SIGN_IN_METHOD="github.com";K.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Y extends Pe{constructor(){super("twitter.com")}static credential(e,i){return se._fromParams({providerId:Y.PROVIDER_ID,signInMethod:Y.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:i})}static credentialFromResult(e){return Y.credentialFromTaggedObject(e)}static credentialFromError(e){return Y.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:i,oauthTokenSecret:n}=e;if(!i||!n)return null;try{return Y.credential(i,n)}catch{return null}}}Y.TWITTER_SIGN_IN_METHOD="twitter.com";Y.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vo(t,e){return Se(t,"POST","/v1/accounts:signUp",Q(t,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class We extends N{constructor(e,i,n,r){super(i.code,i.message),this.operationType=n,this.user=r,Object.setPrototypeOf(this,We.prototype),this.customData={appName:e.name,tenantId:e.tenantId??void 0,_serverResponse:i.customData._serverResponse,operationType:n}}static _fromErrorAndOperation(e,i,n,r){return new We(e,i,n,r)}}function Rn(t,e,i,n){return(e==="reauthenticate"?i._getReauthenticationResolver(t):i._getIdTokenResponse(t)).catch(s=>{throw s.code==="auth/multi-factor-auth-required"?We._fromErrorAndOperation(t,s,e,n):s})}async function Go(t,e,i=!1){const n=await fe(t,e._linkToIdToken(t.auth,await t.getIdToken()),i);return ae._forOperation(t,"link",n)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class On{constructor(e,i){this.storageRetriever=e,this.type=i}_isAvailable(){try{return this.storage?(this.storage.setItem(He,"1"),this.storage.removeItem(He),Promise.resolve(!0)):Promise.resolve(!1)}catch{return Promise.resolve(!1)}}_set(e,i){return this.storage.setItem(e,JSON.stringify(i)),Promise.resolve()}_get(e){const i=this.storage.getItem(e);return Promise.resolve(i?JSON.parse(i):null)}_remove(e){return this.storage.removeItem(e),Promise.resolve()}get storage(){return this.storageRetriever()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xe{constructor(e){this.eventTarget=e,this.handlersMap={},this.boundEventHandler=this.handleEvent.bind(this)}static _getInstance(e){const i=this.receivers.find(r=>r.isListeningto(e));if(i)return i;const n=new Xe(e);return this.receivers.push(n),n}isListeningto(e){return this.eventTarget===e}async handleEvent(e){const i=e,{eventId:n,eventType:r,data:s}=i.data,a=this.handlersMap[r];if(!a?.size)return;i.ports[0].postMessage({status:"ack",eventId:n,eventType:r});const c=Array.from(a).map(async d=>d(i.origin,s)),l=await ac(c);i.ports[0].postMessage({status:"done",eventId:n,eventType:r,response:l})}_subscribe(e,i){Object.keys(this.handlersMap).length===0&&this.eventTarget.addEventListener("message",this.boundEventHandler),this.handlersMap[e]||(this.handlersMap[e]=new Set),this.handlersMap[e].add(i)}_unsubscribe(e,i){this.handlersMap[e]&&i&&this.handlersMap[e].delete(i),(!i||this.handlersMap[e].size===0)&&delete this.handlersMap[e],Object.keys(this.handlersMap).length===0&&this.eventTarget.removeEventListener("message",this.boundEventHandler)}}Xe.receivers=[];/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ic="pendingRedirect",Ne=new Map;class _c extends jn{constructor(e,i,n=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],i,void 0,n),this.eventId=null}async execute(){let e=Ne.get(this.auth._key());if(!e){try{const n=await Ec(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(n)}catch(i){e=()=>Promise.reject(i)}Ne.set(this.auth._key(),e)}return this.bypassAuthState||Ne.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const i=await this.auth._redirectUserForId(e.eventId);if(i)return this.user=i,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function Ec(t,e){const i=Pc(e),n=Sc(t);if(!await n._isAvailable())return!1;const r=await n._get(i)==="true";return await n._remove(i),r}function Tc(t,e){Ne.set(t._key(),e)}function Sc(t){return $(t._redirectPersistence)}function Pc(t){return ze(Ic,t.config.apiKey,t.name)}async function Ac(t,e,i=!1){if(A(t.app))return Promise.reject(U(t));const n=ce(t),r=yc(n,e),a=await new _c(n,r,i).execute();return a&&!i&&(delete a.user._redirectEventId,await n._persistUserIfCurrent(a.user),await n._setRedirectUser(null,e)),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $c=new Te(3e4,6e4);function yi(){const t=O().___jsl;if(t?.H){for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let i=0;i<t.CP.length;i++)t.CP[i]=null}}function Uc(t){return new Promise((e,i)=>{function n(){yi(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{yi(),i(D(t,"network-request-failed"))},timeout:$c.get()})}if(O().gapi?.iframes?.Iframe)e(gapi.iframes.getContext());else if(O().gapi?.load)n();else{const r=Co("iframefcb");return O()[r]=()=>{gapi.load?n():i(D(t,"network-request-failed"))},Sn(`${Ao()}?onload=${r}`).catch(s=>i(s))}}).catch(e=>{throw Me=null,e})}let Me=null;function qc(t){return Me=Me||Uc(t),Me}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tl="__/auth/handler",il="emulator/auth/handler",nl=encodeURIComponent("fac");async function wi(t,e,i,n,r,s){f(t.config.authDomain,t,"auth-domain-config-required"),f(t.config.apiKey,t,"invalid-api-key");const a={apiKey:t.config.apiKey,appName:t.name,authType:i,redirectUrl:n,v:Ee,eventId:r};if(e instanceof Cn){e.setDefaultLanguage(t.languageCode),a.providerId=e.providerId||"",fr(e.getCustomParameters())||(a.customParameters=JSON.stringify(e.getCustomParameters()));for(const[g,u]of Object.entries({}))a[g]=u}if(e instanceof Pe){const g=e.getScopes().filter(u=>u!=="");g.length>0&&(a.scopes=g.join(","))}t.tenantId&&(a.tid=t.tenantId);const c=a;for(const g of Object.keys(c))c[g]===void 0&&delete c[g];const l=await t._getAppCheckToken(),d=l?`#${nl}=${encodeURIComponent(l)}`:"";return`${rl(t)}?${_e(c).slice(1)}${d}`}function rl({config:t}){return t.emulator?Lt(t,il):`https://${t.authDomain}/${tl}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */const dl=5*60,ul=Ci("authIdTokenMaxAge")||dl;let Ii=null;const pl=t=>async e=>{const i=e&&await e.getIdTokenResult(),n=i&&(new Date().getTime()-Date.parse(i.issuedAtTime))/1e3;if(n&&n>ul)return;const r=i?.token;Ii!==r&&(Ii=r,await fetch(t,{method:r?"POST":"DELETE",headers:r?{Authorization:`Bearer ${r}`}:{}}))};function hl(t=Ui()){const e=ge(t,"auth");if(e.isInitialized())return e.getImmediate();const i=Oo(t,{popupRedirectResolver:al,persistence:[vc,sc,Mn]}),n=Ci("authTokenSyncURL");if(n&&typeof isSecureContext=="boolean"&&isSecureContext){const s=new URL(n,location.origin);if(location.origin===s.origin){const a=pl(s.toString());tc(i,a,()=>a(i.currentUser)),ec(i,c=>a(c))}}const r=sr("auth");return r&&No(i,`http://${r}`),i}function fl(){return document.getElementsByTagName("head")?.[0]??document}So({loadJS(t){return new Promise((e,i)=>{const n=document.createElement("script");n.setAttribute("src",t),n.onload=e,n.onerror=r=>{const s=D("internal-error");s.customData=r,i(s)},n.type="text/javascript",n.charset="UTF-8",fl().appendChild(n)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});ll("Browser");const gl={apiKey:"AIzaSyABnvYQl4QzP1lHF4Ei_AzrDPYlMKoTXpA",authDomain:"yathralanka-2ac43.firebaseapp.com",projectId:"yathralanka-2ac43",storageBucket:"yathralanka-2ac43.firebasestorage.app",measurementId:"G-KXWXP8TGMS",appId:"1:1032179534120:web:21d200d59018319f7ca81d",messagingSenderId:"1032179534120"},Hn=$i(gl);Ka(Hn);const te=hl(Hn);let o={currentScreen:"splash",user:{...De},activeSite:null,dwellTimer:null,dwellTimeLeft:900,dwellActive:!1,cooldownTimer:null,cooldownTimeLeft:300,cooldownActive:!1,cameraAttempt:1,currentQuizIndex:0,quizCorrectAnswers:0,quizAnswers:[],petitionSignatures:8742,petitionSigned:!1,donationAmount:0,navStack:[]};document.addEventListener("DOMContentLoaded",()=>{p("splash")});function p(t,e=!0){e&&o.currentScreen!==t&&o.navStack.push(o.currentScreen),o.currentScreen=t,T()}function b(){if(o.navStack.length>0){const t=o.navStack.pop();o.currentScreen=t,T()}else p("dashboard")}function k(t,e=""){o.user.xp+=t;let i="None";Kn.forEach(n=>{o.user.xp>=n.threshold&&(i=n.rank)}),o.user.rank!==i&&(o.user.rank=i,x(`New Rank Unlocked: ${i}!`)),e&&x(`${e} (+${t} XP)`)}function x(t){const e=document.createElement("div");e.style.cssText=`
  ...
  `).join(""),document.querySelectorAll("[data-site-grid-id]").forEach(s=>{s.addEventListener("click",()=>{const a=s.getAttribute("data-site-grid-id"),c=xe.find(l=>l.id===a);c&&(o.activeSite=c,p("site-detail"))})})}function dt(t,e=""){const i=document.getElementById("list-cards-container");if(!i)return;const n=e.toLowerCase(),r=xe.filter(s=>{const a=s.category===t,c=s.name.toLowerCase().includes(n)||s.district.toLowerCase().includes(n);return a&&c});if(r.length===0){i.innerHTML='<div style="text-align: center; color: var(--color-gray); padding: 20px; font-size:12px;">No matching locations found</div>';return}i.innerHTML=r.map(s=>`
  ...
  `).join(""),document.querySelectorAll("[data-site-list-id]").forEach(s=>{s.addEventListener("click",()=>{const a=s.getAttribute("data-site-list-id"),c=xe.find(l=>l.id===a);c&&(o.activeSite=c,p("site-detail"))})})}function rd(t){const e=document.getElementById("map-popup-card");e&&e.remove();const i=document.getElementById("map-popup-container");if(!i)return;const n=document.createElement("div");n.id="map-popup-card",n.className="map-popup-card",n.innerHTML=`
