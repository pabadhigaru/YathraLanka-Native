 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function q6(){if(hh())try{await dh()}catch(n){return We.warn(ut.create("indexeddb-unavailable",{errorInfo:n?.toString()}).message),!1}else return We.warn(ut.create("indexeddb-unavailable",{errorInfo:"IndexedDB is not available in this environment."}).message),!1;return!0}async function j6(n,e,t,r,i,s,a){const c=M6(n);c.then(T=>{t[T.measurementId]=T.appId,n.options.measurementId&&T.measurementId!==n.options.measurementId&&We.warn(`The measurement ID in the local Firebase config (${n.options.measurementId}) does not match the measurement ID fetched from the server (${T.measurementId}). To ensure analytics events are always sent to the correct Analytics property, update the measurement ID field in the local config or remove it from the local config.`)}).catch(T=>We.error(T)),e.push(c);const l=q6().then(T=>{if(T)return r.getId()}),[h,p]=await Promise.all([c,l]);k6(s)||b6(s,h.measurementId),i("js",new Date);const f=a?.config??{};return f[v6]="firebase",f.update=!0,p!=null&&(f[_6]=p),i("config",h.measurementId,f),h.measurementId}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Us(n){const e=n.auth,t=await n.getIdToken(),r=await mi(n,Fs(e,{idToken:t}));Y(r?.users.length,e,"internal-error");const i=r.users[0];n._notifyReloadListener(i);const s=i.providerUserInfo?.length?Wh(i.providerUserInfo):[],a=yg(n.providerData,s),c=n.isAnonymous,l=!(n.email&&i.passwordHash)&&!a?.length,h=c?l:!1,p={uid:i.localId,displayName:i.displayName||null,photoURL:i.photoUrl||null,email:i.email||null,emailVerified:i.emailVerified||!1,phoneNumber:i.phoneNumber||null,tenantId:i.tenantId||null,providerData:a,metadata:new Po(i.createdAt,i.lastLoginAt),isAnonymous:h};Object.assign(n,p)}async function mg(n){const e=Ke(n);await Us(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function yg(n,e){return[...n.filter(r=>!e.some(i=>i.providerId===r.providerId)),...e]}function Wh(n){return n.map(({providerId:e,...t})=>({providerId:e,uid:t.rawId||"",displayName:t.displayName||null,email:t.email||null,phoneNumber:t.phoneNumber||null,photoURL:t.photoUrl||null}))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Dg(n,e){const t=Qn(n,"auth");if(t.isInitialized()){const i=t.getImmediate(),s=t.getOptions();if(vn(s,e??{}))return i;Tt(i,"already-initialized")}return t.initialize({options:e})}function Vg(n,e){const t=e?.persistence||[],r=(Array.isArray(t)?t:[t]).map(zt);e?.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e?.popupRedirectResolver)}function Lg(n,e,t){const r=Xn(n);Y(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const i=!1,s=ad(e),{host:a,port:c}=Mg(e),l=c===null?"":`:${c}`,h={url:`${s}//${a}${l}/`},p=Object.freeze({host:a,port:c,protocol:s.replace(":",""),options:Object.freeze({disableWarnings:i})});if(!r._canInitEmulator){Y(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),Y(vn(h,r.config.emulator)&&vn(p,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=h,r.emulatorConfig=p,r.settings.appVerificationDisabledForTesting=!0,Mi(a)?ph(`${s}//${a}${l}`):Fg()}function ad(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function Mg(n){const e=ad(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(r);if(i){const s=i[1];return{host:s,port:Nu(r.substr(s.length+1))}}else{const[s,a]=r.split(":");return{host:s,port:Nu(a)}}}function Nu(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Fg(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class br{constructor(){this.providerId=br.PROVIDER_ID}static credential(e,t){return yi._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const r=lc.parseLink(t);return Y(r,"argument-error"),yi._fromEmailAndCode(e,r.code,r.tenantId)}}br.PROVIDER_ID="password";br.EMAIL_PASSWORD_SIGN_IN_METHOD="password";br.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mm(n,e){return e?zt(e):(Y(n._popupRedirectResolver,n,"argument-error"),n._popupRedirectResolver)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zm="__/auth/handler",e7="emulator/auth/handler",t7=encodeURIComponent("fac");async function Uu(n,e,t,r,i,s){Y(n.config.authDomain,n,"auth-domain-config-required"),Y(n.config.apiKey,n,"invalid-api-key");const a={apiKey:n.config.apiKey,appName:n.name,authType:t,redirectUrl:r,v:Ar,eventId:i};if(e instanceof od){e.setDefaultLanguage(n.languageCode),a.providerId=e.providerId||"",mf(e.getCustomParameters())||(a.customParameters=JSON.stringify(e.getCustomParameters()));for(const[p,f]of Object.entries({}))a[p]=f}if(e instanceof zi){const p=e.getScopes().filter(f=>f!=="");p.length>0&&(a.scopes=p.join(","))}n.tenantId&&(a.tid=n.tenantId);const c=a;for(const p of Object.keys(c))c[p]===void 0&&delete c[p];const l=await n._getAppCheckToken(),h=l?`#${t7}=${encodeURIComponent(l)}`:"";return`${n7(n)}?${Li(c).slice(1)}${h}`}function n7({config:n}){return n.emulator?sc(n,e7):`https://${n.authDomain}/${Zm}`}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ho="webStorageSupport";class r7{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=fd,this._completeRedirectFn=Sm,this._overrideRedirectResult=Am}async _openPopup(e,t,r,i){Gt(this.eventManagers[e._key()]?.manager,"_initialize() not called before _openPopup()");const s=await Uu(e,t,r,Co(),i);return Xm(e,s,uc())}async _openRedirect(e,t,r,i){await this._originValidation(e);const s=await Uu(e,t,r,Co(),i);return am(s),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:i,promise:s}=this.eventManagers[t];return i?Promise.resolve(i):(Gt(s,"If manager is not set, promise should be"),s)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await Hm(e),r=new Cm(e);return t.register("authEvent",i=>(Y(i?.authEvent,e,"invalid-auth-event"),{status:r.onEvent(i.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(ho,{type:ho},i=>{const s=i?.[0]?.[ho];s!==void 0&&t(!!s),Tt(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=Dm(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return nd()||Qh()||oc()}}const i7=r7;var zu="@firebase/auth",Bu="1.13.3";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vi=-1;function L7(n,e){const t=n.toTimestamp().seconds,r=n.toTimestamp().nanoseconds+1,i=X.fromTimestamp(r===1e9?new de(t+1,0):new de(t,r));return new wn(i,W.empty(),e)}function M7(n){return new wn(n.readTime,n.key,vi)}class wn{constructor(e,t,r){this.readTime=e,this.documentKey=t,this.largestBatchId=r}static min(){return new wn(X.min(),W.empty(),vi)}static max(){return new wn(X.max(),W.empty(),vi)}}function F7(n,e){let t=n.readTime.compareTo(e.readTime);return t!==0?t:(t=W.comparator(n.documentKey,e.documentKey),t!==0?t:re(n.largestBatchId,e.largestBatchId))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Sr(n){if(n.code!==V.FAILED_PRECONDITION||n.message!==U7)throw n;z("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class K7{constructor(e,t,r,i,s,a,c,l,h,p,f){this.databaseId=e,this.appId=t,this.persistenceKey=r,this.host=i,this.ssl=s,this.forceLongPolling=a,this.autoDetectLongPolling=c,this.longPollingOptions=l,this.useFetchStreams=h,this.isUsingEmulator=p,this.apiKey=f}}const Hs="(default)";class Ei{constructor(e,t){this.projectId=e,this.database=t||Hs}static empty(){return new Ei("","")}get isDefaultDatabase(){return this.database===Hs}isEqual(e){return e instanceof Ei&&e.projectId===this.projectId&&e.database===this.database}}function Y7(n,e){if(!Object.prototype.hasOwnProperty.apply(n.options,["projectId"]))throw new q(V.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Ei(n.options.projectId,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const I4=new ge(W.comparator);function et(){return I4}const ip=new ge(W.comparator);function or(...n){let e=ip;for(const t of n)e=e.insert(t.key,t);return e}function sp(n){let e=ip;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function hn(){return hi()}function ap(){return hi()}function hi(){return new er(n=>n.toString(),(n,e)=>n.isEqual(e))}const A4=new ge(W.comparator),b4=new Ie(W.comparator);function ne(...n){let e=b4;for(const t of n)e=e.add(t);return e}const x4=new Ie(re);function S4(){return x4}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const go="RestConnection",Q4={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery",ExecutePipeline:"executePipeline"};class X4{get Ot(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.Mt=t+"://"+e.host,this.Nt=`projects/${r}/databases/${i}`,this.Lt=this.databaseId.database===Hs?`project_id=${r}`:`project_id=${r}&database_id=${i}`}Bt(e,t,r,i,s){const a=Bo(),c=this.Ut(e,t.toUriEncodedString());z(go,`Sending RPC '${e}' ${a}:`,c,r);const l={"google-cloud-resource-prefix":this.Nt,"x-goog-request-params":this.Lt};this.kt(l,i,s);const{host:h}=new URL(c),p=Mi(h);return this.qt(e,c,l,r,p).then(f=>(z(go,`Received RPC '${e}' ${a}: `,f),f),f=>{throw It(go,`RPC '${e}' ${a} failed with error: `,f,"url: ",c,"request:",r),f})}$t(e,t,r,i,s,a){return this.Bt(e,t,r,i,s)}kt(e,t,r){e["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+xr}(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((i,s)=>e[s]=i),r&&r.headers.forEach((i,s)=>e[s]=i)}Ut(e,t){const r=Q4[e];let i=`${this.Mt}/v1/${t}:${r}`;return this.databaseInfo.apiKey&&(i=`${i}?key=${encodeURIComponent(this.databaseInfo.apiKey)}`),i}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fe="WebChannelConnection",Qr=(n,e,t)=>{n.listen(e,r=>{try{t(r)}catch(i){setTimeout(()=>{throw i},0)}})};class mr extends X4{constructor(e){super(e),this.nn=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static rn(){if(!mr.sn){const e=xd();Qr(e,bd.STAT_EVENT,t=>{t.stat===No.PROXY?z(Fe,"STAT_EVENT: detected buffering proxy"):t.stat===No.NOPROXY&&z(Fe,"STAT_EVENT: detected no buffering proxy")}),mr.sn=!0}}qt(e,t,r,i,s){const a=Bo();return new Promise((c,l)=>{const h=new Id;h.setWithCredentials(!0),h.listenOnce(Ad.COMPLETE,()=>{try{switch(h.getLastErrorCode()){case Ss.NO_ERROR:const f=h.getResponseJson();z(Fe,`XHR for RPC '${e}' ${a} received:`,JSON.stringify(f)),c(f);break;case Ss.TIMEOUT:z(Fe,`RPC '${e}' ${a} timed out`),l(new q(V.DEADLINE_EXCEEDED,"Request time out"));break;case Ss.HTTP_ERROR:const T=h.getStatus();if(z(Fe,`RPC '${e}' ${a} failed with status:`,T,"response text:",h.getResponseText()),T>0){let C=h.getResponseJson();Array.isArray(C)&&(C=C[0]);const N=C?.error;if(N&&N.status&&N.message){const L=function(J){const ce=J.toLowerCase().replace(/_/g,"-");return Object.values(V).indexOf(ce)>=0?ce:V.UNKNOWN}(N.status);l(new q(L,N.message))}else l(new q(V.UNKNOWN,"Server responded with status "+h.getStatus()))}else l(new q(V.UNAVAILABLE,"Connection failed."));break;default:G(9055,{_n:e,streamId:a,an:h.getLastErrorCode(),un:h.getLastError()})}}finally{z(Fe,`RPC '${e}' ${a} completed.`)}});const p=JSON.stringify(i);z(Fe,`RPC '${e}' ${a} sending request:`,i),h.send(t,"POST",p,r,15)})}cn(e,t,r){const i=Bo(),s=[this.Mt,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=this.createWebChannelTransport(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},l=this.longPollingOptions.timeoutSeconds;l!==void 0&&(c.longPollingTimeout=Math.round(1e3*l)),this.useFetchStreams&&(c.useFetchStreams=!0),this.kt(c.initMessageHeaders,t,r),c.encodeInitMessageHeaders=!0;const h=s.join("");z(Fe,`Creating RPC '${e}' stream ${i}: ${h}`,c);const p=a.createWebChannel(h,c);this.En(p);let f=!1,T=!1;const C=new J4({Kt:N=>{T?z(Fe,`Not sending because RPC '${e}' stream ${i} is closed:`,N):(f||(z(Fe,`Opening RPC '${e}' stream ${i} transport.`),p.open(),f=!0),z(Fe,`RPC '${e}' stream ${i} sending:`,N),p.send(N))},Wt:()=>p.close()});return Qr(p,Zr.EventType.OPEN,()=>{T||(z(Fe,`RPC '${e}' stream ${i} transport opened.`),C.Zt())}),Qr(p,Zr.EventType.CLOSE,()=>{T||(T=!0,z(Fe,`RPC '${e}' stream ${i} transport closed`),C.en(),this.hn(p))}),Qr(p,Zr.EventType.ERROR,N=>{T||(T=!0,It(Fe,`RPC '${e}' stream ${i} transport errored. Name:`,N.name,"Message:",N.message),C.en(new q(V.UNAVAILABLE,"The operation could not be completed")))}),Qr(p,Zr.EventType.MESSAGE,N=>{if(!T){const L=N.data[0];j(!!L,16349);const B=L,J=B?.error||B[0]?.error;if(J){z(Fe,`RPC '${e}' stream ${i} received error:`,J);const ce=J.status;let ye=function(De){const A=Ee[De];if(A!==void 0)return rp(A)}(ce),Ye=J.message;ce==="NOT_FOUND"&&Ye.includes("database")&&Ye.includes("does not exist")&&Ye.includes(this.databaseId.database)&&It(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),ye===void 0&&(ye=V.INTERNAL,Ye="Unknown error status: "+ce+" with message "+J.message),T=!0,C.en(new q(ye,Ye)),p.close()}else z(Fe,`RPC '${e}' stream ${i} received:`,L),C.tn(L)}}),mr.rn(),setTimeout(()=>{C.Xt()},0),C}terminate(){this.nn.forEach(e=>e.close()),this.nn=[]}En(e){this.nn.push(e)}hn(e){this.nn=this.nn.filter(t=>t===e)}kt(e,t,r){super.kt(e,t,r),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return Sd()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
class E{constructor(e,t){this.type=e,this.value=t}static vr(){return new E("ERROR",void 0)}static Sr(){return new E("UNSET",void 0)}static Dr(){return new E("NULL",wr)}static newValue(e){return lt(e)?new E("NULL",wr):function(r){return!!r&&"booleanValue"in r}(e)?new E("BOOLEAN",e):Rt(e)?new E("INT",e):zn(e)?new E("DOUBLE",e):function(r){return!!r&&"timestampValue"in r&&!!r.timestampValue}(e)?new E("TIMESTAMP",e):function(r){return!!r&&"stringValue"in r}(e)?new E("STRING",e):function(r){return!!r&&"bytesValue"in r}(e)?new E("BYTES",e):e.referenceValue?new E("REFERENCE",e):e.geoPointValue?new E("GEO_POINT",e):Tr(e)?new E("ARRAY",e):Gs(e)?new E("VECTOR",e):Bn(e)?new E("MAP",e):new E("ERROR",void 0)}Cr(){return this.type==="ERROR"||this.type==="UNSET"}Fr(){return this.type==="NULL"}}function di(n){if(!n.Cr())return n.value}function Lp(n){return n instanceof An?n._expr:n}function K(n){if((n=Lp(n))instanceof Ki)return new V3(n);if(n instanceof Cr)return new L3(n);if(n instanceof ti)return new M3(n);if(n instanceof O){if(n.name==="add")return new z3(n);if(n.name==="subtract")return new B3(n);if(n.name==="multiply")return new $3(n);if(n.name==="divide")return new q3(n);if(n.name==="mod")return new j3(n);if(n.name==="and")return new H3(n);if(n.name==="equal")return new r9(n);if(n.name==="not_equal")return new i9(n);if(n.name==="less_than")return new s9(n);if(n.name==="less_than_or_equal")return new a9(n);if(n.name==="greater_than")return new o9(n);if(n.name==="greater_than_or_equal")return new c9(n);if(n.name==="array_concat")return new l9(n);if(n.name==="array_reverse")return new u9(n);if(n.name==="array_contains")return new h9(n);if(n.name==="array_contains_all")return new d9(n);if(n.name==="array_contains_any")return new p9(n);if(n.name==="array_length")return new f9(n);if(n.name==="array_element")return new g9(n);if(n.name==="equal_any")return new Mp(n);if(n.name==="not_equal_any")return new W3(n);if(n.name==="is_nan")return new K3(n);if(n.name==="is_not_nan")return new Y3(n);if(n.name==="is_null")return new Q3(n);if(n.name==="is_not_null")return new X3(n);if(n.name==="is_error")return new J3(n);if(n.name==="exists")return new Z3(n);if(n.name==="not")return new Sa(n);if(n.name==="or")return new G3(n);if(n.name==="xor")return new Vc(n);if(n.name==="conditional")return new e9(n);if(n.name==="maximum")return new t9(n);if(n.name==="minimum")return new n9(n);if(n.name==="reverse")return new m9(n);if(n.name==="replace_first")return new y9(n);if(n.name==="replace_all")return new _9(n);if(n.name==="char_length")return new v9(n);if(n.name==="byte_length")return new w9(n);if(n.name==="like")return new E9(n);if(n.name==="regex_contains")return new T9(n);if(n.name==="regex_match")return new I9(n);if(n.name==="string_contains")return new A9(n);if(n.name==="starts_with")return new b9(n);if(n.name==="ends_with")return new x9(n);if(n.name==="to_lower")return new S9(n);if(n.name==="to_upper")return new R9(n);if(n.name==="trim")return new C9(n);if(n.name==="string_concat")return new P9(n);if(n.name==="map_get")return new k9(n);if(n.name==="cosine_distance")return new N9(n);if(n.name==="dot_product")return new O9(n);if(n.name==="euclidean_distance")return new D9(n);if(n.name==="vector_length")return new V9(n);if(n.name==="unix_micros_to_timestamp")return new z9(n);if(n.name==="timestamp_to_unix_micros")return new q9(n);if(n.name==="unix_millis_to_timestamp")return new B9(n);if(n.name==="timestamp_to_unix_millis")return new j9(n);if(n.name==="unix_seconds_to_timestamp")return new $9(n);if(n.name==="timestamp_to_unix_seconds")return new H9(n);if(n.name==="timestamp_add")return new G9(n);if(n.name==="timestamp_subtract")return new W9(n)}throw new Error(`Unknown Expr : ${n}`)}class V3{constructor(e){this.expr=e}evaluate(e,t){if(this.expr.fieldName===_r)return E.newValue({referenceValue:ea(e.serializer,t.key)});if(this.expr.fieldName==="__update_time__")return E.newValue({timestampValue:ks(e.serializer,t.version)});if(this.expr.fieldName==="__create_time__")return E.newValue({timestampValue:ks(e.serializer,t.createTime)});const r=t.data.field(this.expr._fieldPath);return r?ma(r)?E.newValue(function(s,a){if(s.serverTimestampBehavior==="estimate")return{timestampValue:ks(s.serializer,X.fromTimestamp(vr(a)))};if(s.serverTimestampBehavior==="previous"){const c=ji(a);if(c)return c}return{nullValue:"NULL_VALUE"}}(e,r)):E.newValue(r):E.Sr()}}class L3{constructor(e){this.expr=e}evaluate(e,t){return E.newValue(this.expr._getValue())}}class M3{constructor(e){this.expr=e}evaluate(e,t){const r=this.expr.Rr.map(i=>K(i).evaluate(e,t));return r.some(i=>i.Cr())?E.vr():E.newValue({arrayValue:{values:r.map(i=>i.value)}})}}function Le(n){return zn(n)?Number(n.doubleValue):Number(n.integerValue)}function Lt(n){return BigInt(n.integerValue)}const F3=BigInt("0x7fffffffffffffff"),U3=-BigInt("0x8000000000000000");class Yi{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length>=2,24778);const r=K(this.expr.params[0]).evaluate(e,t),i=K(this.expr.params[1]).evaluate(e,t);let s=this.Or(r,i);for(const a of this.expr.params.slice(2)){const c=K(a).evaluate(e,t);s=this.Or(s,c)}return s}Or(e,t){if(e.Cr()||t.Cr())return E.vr();if(e.Fr()||t.Fr())return E.Dr();const r=e.value,i=t.value;if(!zn(r)&&!Rt(r)||!zn(i)&&!Rt(i))return E.vr();if(zn(r)||zn(i)){const s=this.Mr(r,i);return s?E.newValue(s):E.vr()}if(Rt(r)&&Rt(i)){const s=this.Nr(r,i);return s===void 0?E.vr():typeof s=="number"?E.newValue({doubleValue:s}):s<U3||s>F3?E.vr():E.newValue({integerValue:`${s}`})}return E.vr()}}function Yt(n,e){return be(n)!==be(e)?"TYPE_MISMATCH":it(n)||it(e)?"NOT_EQ":lt(n)&&lt(e)?"EQ":lt(n)||lt(e)?"NULL":Tr(n)&&Tr(e)?function(r,i){if(r.values?.length!==i.values?.length)return"NOT_EQ";let s=!1;for(let a=0;a<(r.values?.length??0);a++){const c=r.values[a],l=i.values[a];switch(Yt(c,l)){case"EQ":break;case"NOT_EQ":case"TYPE_MISMATCH":return"NOT_EQ";case"NULL":s=!0;break;default:G(44609,{Lr:c,Br:l})}}return s?"NULL":"EQ"}(n.arrayValue,e.arrayValue):Gs(n)&&Gs(e)||Bn(n)&&Bn(e)?function(r,i){const s=r.fields||{},a=i.fields||{};if(js(s)!==js(a))return"NOT_EQ";let c=!1;for(const l in s)if(s.hasOwnProperty(l)){if(a[l]===void 0)return"NOT_EQ";switch(Yt(s[l],a[l])){case"NOT_EQ":case"TYPE_MISMATCH":return"NOT_EQ";case"NULL":c=!0}}return c?"NULL":"EQ"}(n.mapValue,e.mapValue):function(r,i){return mt(r,i,{Te:!1,Ee:!0,he:!0})}(n,e)?"EQ":"NOT_EQ"}class z3 extends Yi{Nr(e,t){return Lt(e)+Lt(t)}Mr(e,t){return{doubleValue:Le(e)+Le(t)}}}class B3 extends Yi{constructor(e){super(e),this.expr=e}Nr(e,t){return Lt(e)-Lt(t)}Mr(e,t){return{doubleValue:Le(e)-Le(t)}}}class $3 extends Yi{constructor(e){super(e),this.expr=e}Nr(e,t){return Lt(e)*Lt(t)}Mr(e,t){return{doubleValue:Le(e)*Le(t)}}}class q3 extends Yi{constructor(e){super(e),this.expr=e}Nr(e,t){const r=Lt(t);if(r!==BigInt(0))return Lt(e)/r}Mr(e,t){const r=Le(t);return r===0?{doubleValue:wi(r)?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY}:{doubleValue:Le(e)/r}}}class j3 extends Yi{constructor(e){super(e),this.expr=e}Nr(e,t){const r=Lt(t);if(r!==BigInt(0))return Lt(e)%r}Mr(e,t){const r=Le(t);if(r!==0)return{doubleValue:Le(e)%r}}}class H3{constructor(e){this.expr=e}evaluate(e,t){let r=!1,i=!1;for(const s of this.expr.params){const a=K(s).evaluate(e,t);switch(a.type){case"BOOLEAN":if(!a.value?.booleanValue)return E.newValue(Oe);break;case"NULL":i=!0;break;default:r=!0}}return r?E.vr():i?E.Dr():E.newValue(nt)}}class Sa{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length===1,9634);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"BOOLEAN":return E.newValue({booleanValue:!r.value?.booleanValue});case"NULL":return E.Dr();default:return E.vr()}}}class G3{constructor(e){this.expr=e}evaluate(e,t){let r=!1,i=!1;for(const s of this.expr.params){const a=K(s).evaluate(e,t);switch(a.type){case"BOOLEAN":if(a.value?.booleanValue)return E.newValue(nt);break;case"NULL":i=!0;break;default:r=!0}}return r?E.vr():i?E.Dr():E.newValue(Oe)}}class Vc{constructor(e){this.expr=e}evaluate(e,t){let r=!1,i=!1;for(const s of this.expr.params){const a=K(s).evaluate(e,t);switch(a.type){case"BOOLEAN":r=Vc.xor(r,!!a.value?.booleanValue);break;case"NULL":i=!0;break;default:return E.vr()}}return i?E.Dr():E.newValue({booleanValue:r})}static xor(e,t){return(e||t)&&!(e&&t)}}class Mp{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length===2,55094);let r=!1;const i=K(this.expr.params[0]).evaluate(e,t);switch(i.type){case"NULL":r=!0;break;case"ERROR":case"UNSET":return E.vr()}const s=K(this.expr.params[1]).evaluate(e,t);switch(s.type){case"ARRAY":break;case"NULL":r=!0;break;default:return E.vr()}if(r)return E.Dr();for(const a of s.value?.arrayValue?.values??[])switch(lt(i.value)&&lt(a)?"EQ":Yt(i.value,a)){case"EQ":return E.newValue(nt);case"NOT_EQ":case"TYPE_MISMATCH":break;case"NULL":r=!0;break;default:G(44608,{value:i.value,candidate:a})}return r?E.Dr():E.newValue(Oe)}}class W3{constructor(e){this.expr=e}evaluate(e,t){return new Sa(new O("not",[new O("equal_any",this.expr.params)])).evaluate(e,t)}}class K3{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length===1,23322);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"INT":return E.newValue(Oe);case"DOUBLE":return E.newValue({booleanValue:isNaN(Le(r.value))});case"NULL":return E.Dr();default:return E.vr()}}}class Y3{constructor(e){this.expr=e}evaluate(e,t){return j(this.expr.params.length===1,50406),new Sa(new O("not",[new O("is_nan",this.expr.params)])).evaluate(e,t)}}class Q3{constructor(e){this.expr=e}evaluate(e,t){switch(j(this.expr.params.length===1,23123),K(this.expr.params[0]).evaluate(e,t).type){case"NULL":return E.newValue(nt);case"UNSET":case"ERROR":return E.vr();default:return E.newValue(Oe)}}}class X3{constructor(e){this.expr=e}evaluate(e,t){return j(this.expr.params.length===1,23167),new Sa(new O("not",[new O("is_null",this.expr.params)])).evaluate(e,t)}}class J3{constructor(e){this.expr=e}evaluate(e,t){return j(this.expr.params.length===1,5228),K(this.expr.params[0]).evaluate(e,t).type==="ERROR"?E.newValue(nt):E.newValue(Oe)}}class Z3{constructor(e){this.expr=e}evaluate(e,t){switch(j(this.expr.params.length===1,6877),K(this.expr.params[0]).evaluate(e,t).type){case"ERROR":return E.vr();case"UNSET":return E.newValue(Oe);default:return E.newValue(nt)}}}class e9{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length===3,11706);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"BOOLEAN":return r.value?.booleanValue?K(this.expr.params[1]).evaluate(e,t):K(this.expr.params[2]).evaluate(e,t);case"NULL":return K(this.expr.params[2]).evaluate(e,t);default:return E.vr()}}}class t9{constructor(e){this.expr=e}evaluate(e,t){const r=this.expr.params.map(s=>K(s).evaluate(e,t));let i;for(const s of r)switch(s.type){case"ERROR":case"UNSET":case"NULL":continue;default:i=i===void 0||rt(s.value,i.value)>0?s:i}return i===void 0?E.Dr():i}}class n9{constructor(e){this.expr=e}evaluate(e,t){const r=this.expr.params.map(s=>K(s).evaluate(e,t));let i;for(const s of r)switch(s.type){case"ERROR":case"UNSET":case"NULL":continue;default:i=i===void 0||rt(s.value,i.value)<0?s:i}return i===void 0?E.Dr():i}}class Pr{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length===2,31033,`${this.expr.name}() function should have exactly 2 params`);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"ERROR":case"UNSET":return E.vr()}const i=K(this.expr.params[1]).evaluate(e,t);switch(i.type){case"ERROR":case"UNSET":return E.vr()}return this.Ur(r,i)}}class r9 extends Pr{constructor(e){super(e),this.expr=e}Ur(e,t){if(e.Fr()&&t.Fr())return E.newValue(nt);if(e.Fr()||t.Fr()||it(e.value)||it(t.value)||be(e.value)!==be(t.value))return E.newValue(Oe);switch(Yt(e.value,t.value)){case"EQ":return E.newValue(nt);case"NOT_EQ":return E.newValue(Oe);case"NULL":return E.Dr();default:G(44615,{left:e,right:t})}}}class i9 extends Pr{constructor(e){super(e),this.expr=e}Ur(e,t){switch(Yt(e.value,t.value)){case"EQ":return E.newValue(Oe);case"NOT_EQ":case"TYPE_MISMATCH":return E.newValue(nt);case"NULL":return E.Dr();default:G(44614,{left:e,right:t})}}}class s9 extends Pr{constructor(e){super(e),this.expr=e}Ur(e,t){return be(e.value)!==be(t.value)||it(e.value)||it(t.value)?E.newValue(Oe):E.newValue({booleanValue:rt(e.value,t.value)<0})}}class a9 extends Pr{constructor(e){super(e),this.expr=e}Ur(e,t){return be(e.value)!==be(t.value)||it(e.value)||it(t.value)?E.newValue(Oe):Yt(e.value,t.value)==="EQ"?E.newValue(nt):E.newValue({booleanValue:rt(e.value,t.value)<0})}}class o9 extends Pr{constructor(e){super(e),this.expr=e}Ur(e,t){return be(e.value)!==be(t.value)||it(e.value)||it(t.value)?E.newValue(Oe):E.newValue({booleanValue:rt(e.value,t.value)>0})}}class c9 extends Pr{constructor(e){super(e),this.expr=e}Ur(e,t){return be(e.value)!==be(t.value)||it(e.value)||it(t.value)?E.newValue(Oe):Yt(e.value,t.value)==="EQ"?E.newValue(nt):E.newValue({booleanValue:rt(e.value,t.value)>0})}}class l9{constructor(e){this.expr=e}evaluate(e,t){throw new Error("Unimplemented")}}class u9{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length===1,216);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"NULL":return E.Dr();case"ARRAY":{const i=r.value.arrayValue?.values??[];return E.newValue({arrayValue:{values:[...i].reverse()}})}default:return E.vr()}}}class h9{constructor(e){this.expr=e}evaluate(e,t){return j(this.expr.params.length===2,52884),new Mp(new O("eq_any",[this.expr.params[1],this.expr.params[0]])).evaluate(e,t)}}class d9{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length===2,1392);let r=!1;const i=K(this.expr.params[0]).evaluate(e,t);switch(i.type){case"ARRAY":break;case"NULL":r=!0;break;default:return E.vr()}const s=K(this.expr.params[1]).evaluate(e,t);switch(s.type){case"ARRAY":break;case"NULL":r=!0;break;default:return E.vr()}if(r)return E.Dr();const a=s.value?.arrayValue?.values??[],c=i.value?.arrayValue?.values??[];for(const l of a){let h=!1;r=!1;for(const p of c){switch(lt(l)&&lt(p)?"EQ":Yt(l,p)){case"EQ":h=!0;break;case"NOT_EQ":case"TYPE_MISMATCH":break;case"NULL":r=!0;break;default:G(44613,{value:p,search:l})}if(h)break}if(!h)return E.newValue(Oe)}return E.newValue(nt)}}class p9{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length===2,2680);let r=!1;const i=K(this.expr.params[0]).evaluate(e,t);switch(i.type){case"ARRAY":break;case"NULL":r=!0;break;default:return E.vr()}const s=K(this.expr.params[1]).evaluate(e,t);switch(s.type){case"ARRAY":break;case"NULL":r=!0;break;default:return E.vr()}if(r)return E.Dr();const a=s.value?.arrayValue?.values??[],c=i.value?.arrayValue?.values??[];for(const l of c)for(const h of a)switch(lt(l)&&lt(h)?"EQ":Yt(l,h)){case"EQ":return E.newValue(nt);case"NOT_EQ":case"TYPE_MISMATCH":break;case"NULL":r=!0;break;default:G(44608,{value:l,search:h})}return r?E.Dr():E.newValue(Oe)}}class f9{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length===1,38605);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"NULL":return E.Dr();case"ARRAY":return E.newValue({integerValue:`${r.value?.arrayValue?.values?.length??0}`});default:return E.vr()}}}class g9{constructor(e){this.expr=e}evaluate(e,t){throw new Error("Unimplemented")}}class m9{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length===1,1508);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"NULL":return E.Dr();case"BYTES":{const i=r.value?.bytesValue;if(typeof i=="string"){const s=Ae.fromBase64String(i).toUint8Array();return s.reverse(),E.newValue({bytesValue:Ae.fromUint8Array(s).toBase64()})}return E.newValue({bytesValue:new Uint8Array(i).reverse()})}case"STRING":{const i=r.value?.stringValue,s=new Intl.__PRIVATE_Segmenter(void 0,{granularity:"grapheme"}).segment(i),a=Array.from(s,c=>c.segment).reverse();return E.newValue({stringValue:a.join("")})}default:return E.vr()}}}class y9{constructor(e){this.expr=e}evaluate(e,t){throw new Error("Unimplemented")}}class _9{constructor(e){this.expr=e}evaluate(e,t){throw new Error("Unimplemented")}}class v9{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length===1,19400);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"NULL":return E.Dr();case"STRING":{const i=function(a){let c=0;for(let l=0;l<a.length;l++){const h=a.codePointAt(l);if(h===void 0)return;if(h<=65535)if(h>=55296&&h<=57343)if(h<=56319){const p=a.codePointAt(l+1);p!==void 0&&p>=56320&&p<=57343?(c+=1,l++):c+=1}else c+=1;else c+=1;else{if(!(h<=1114111))return;c+=1,l++}}return c}(r.value.stringValue);return i===void 0?E.vr():E.newValue({integerValue:i})}default:return E.vr()}}}class w9{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length===1,8486);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"BYTES":{const i=r.value?.bytesValue;return typeof i=="string"?E.newValue({integerValue:Ae.fromBase64String(i).toUint8Array().length}):E.newValue({integerValue:new Uint8Array(i).length})}case"STRING":{const i=function(a){let c=0;for(let l=0;l<a.length;l++){const h=a.codePointAt(l);if(h===void 0)return;if(h>=55296&&h<=57343){if(!(h<=56319))return;{const p=a.codePointAt(l+1);if(p===void 0||!(p>=56320&&p<=57343))return;c+=4,l++}}else if(h<=127)c+=1;else if(h<=2047)c+=2;else if(h<=65535)c+=3;else{if(!(h<=1114111))return;c+=4,l++}}return c}(r.value?.stringValue);return i===void 0?E.vr():E.newValue({integerValue:i})}case"NULL":return E.Dr();default:return E.vr()}}}class kr{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length===2,39773,`${this.expr.name}() function should have exactly two parameters`);let r=!1;const i=K(this.expr.params[0]).evaluate(e,t);switch(i.type){case"STRING":break;case"NULL":r=!0;break;default:return E.vr()}const s=K(this.expr.params[1]).evaluate(e,t);switch(s.type){case"STRING":break;case"NULL":r=!0;break;default:return E.vr()}return r?E.Dr():this.kr(i.value?.stringValue,s.value?.stringValue)}}class E9 extends kr{kr(e,t){try{const r=function(a){let c="";for(let l=0;l<a.length;l++){const h=a.charAt(l);switch(h){case"_":c+=".";break;case"%":c+=".*";break;case"\\":case".":case"*":case"?":case"+":case"^":case"$":case"|":case"(":case")":case"[":case"]":case"{":case"}":c+="\\"+h;break;default:c+=h}}return"^"+c+"$"}(t),i=dt.compile(r);return E.newValue({booleanValue:i.matches(e)})}catch(r){return It(`Invalid LIKE pattern converted to regex: ${t}, returning error. Error: ${r}`),E.vr()}}}class T9 extends kr{kr(e,t){try{const r=dt.compile(t);return E.newValue({booleanValue:r.matcher(e).find()})}catch{return It(`Invalid regex pattern found in regex_contains: ${t}, returning error`),E.vr()}}}class I9 extends kr{kr(e,t){try{return E.newValue({booleanValue:dt.compile(t).matches(e)})}catch{return It(`Invalid regex pattern found in regex_match: ${t}, returning error`),E.vr()}}}class A9 extends kr{kr(e,t){return E.newValue({booleanValue:e.includes(t)})}}class b9 extends kr{kr(e,t){return E.newValue({booleanValue:e.startsWith(t)})}}class x9 extends kr{kr(e,t){return E.newValue({booleanValue:e.endsWith(t)})}}class S9{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length===1,29079);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"STRING":return E.newValue({stringValue:r.value?.stringValue?.toLowerCase()});case"NULL":return E.Dr();default:return E.vr()}}}class R9{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length===1,60487);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"STRING":return E.newValue({stringValue:r.value?.stringValue?.toUpperCase()});case"NULL":return E.Dr();default:return E.vr()}}}class C9{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length===1,28544);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"STRING":return E.newValue({stringValue:r.value?.stringValue?.trim()});case"NULL":return E.Dr();default:return E.vr()}}}class P9{constructor(e){this.expr=e}evaluate(e,t){const r=this.expr.params.map(a=>K(a).evaluate(e,t));let i="",s=!1;for(const a of r)switch(a.type){case"STRING":i+=a.value.stringValue;break;case"NULL":s=!0;break;default:return E.vr()}return s?E.Dr():E.newValue({stringValue:i})}}class k9{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length===2,4483);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"UNSET":return E.Sr();case"MAP":break;default:return E.vr()}const i=K(this.expr.params[1]).evaluate(e,t);if(i.type!=="STRING")return E.vr();const s=r.value?.mapValue?.fields?.[i.value?.stringValue];return s===void 0?E.Sr():E.newValue(s)}}class Lc{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length===2,25231,`${this.expr.name}() function should have exactly 2 params`);let r=!1;const i=K(this.expr.params[0]).evaluate(e,t);switch(i.type){case"VECTOR":break;case"NULL":r=!0;break;default:return E.vr()}const s=K(this.expr.params[1]).evaluate(e,t);switch(s.type){case"VECTOR":break;case"NULL":r=!0;break;default:return E.vr()}if(r)return E.Dr();const a=Vo(i.value),c=Vo(s.value);if(a===void 0||c===void 0||a.values?.length!==c.values?.length)return E.vr();const l=this.qr(a,c);return l===void 0||isNaN(l)?E.vr():E.newValue({doubleValue:l})}}class N9 extends Lc{qr(e,t){const r=e?.values??[],i=t?.values??[];if(r.length===0)return;let s=0,a=0,c=0;for(let h=0;h<r.length;h++){if(!In(r[h])||!In(i[h]))return;const p=Le(r[h]),f=Le(i[h]);s+=p*f,a+=p*p,c+=f*f}const l=Math.sqrt(a)*Math.sqrt(c);if(l!==0)return 1-Math.max(-1,Math.min(1,s/l))}}class O9 extends Lc{qr(e,t){const r=e?.values??[],i=t?.values??[];if(r.length===0)return 0;let s=0;for(let a=0;a<r.length;a++){if(!In(r[a])||!In(i[a]))return;s+=Le(r[a])*Le(i[a])}return s}}class D9 extends Lc{qr(e,t){const r=e?.values??[],i=t?.values??[];if(r.length===0)return 0;let s=0;for(let a=0;a<r.length;a++){if(!In(r[a])||!In(i[a]))return;const c=Le(r[a]),l=Le(i[a]);s+=Math.pow(c-l,2)}return Math.sqrt(s)}}class V9{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length===1,39044);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"VECTOR":{const i=Vo(r.value);return E.newValue({integerValue:i?.values?.length??0})}case"NULL":return E.Dr();default:return E.vr()}}}const Ni=BigInt(-62135596800),Oi=BigInt(253402300799),na=BigInt(1e3),yn=BigInt(1e6),L9=Ni*na,M9=Oi*na+BigInt(999),F9=Ni*yn,U9=Oi*yn+BigInt(999999);function Mc(n){return n>=F9&&n<=U9}function Fp(n){return n>=Ni&&n<=Oi}function Di(n,e){const t=BigInt(n);return!(t<Ni||t>Oi)&&!(e<0||e>=1e9)&&(t!==Ni||e===0)&&!(t===Oi&&e>999999999)}function Up(n,e){return e<0?{seconds:n-1,nanos:e+1e9}:{seconds:n,nanos:e}}function Fc(n){return BigInt(n.seconds)*yn+BigInt(Math.trunc(n.nanoseconds/1e3))}class Uc{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length===1,49262,`${this.expr.name}() function should have exactly one parameter`);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"INT":return this.toTimestamp(BigInt(r.value.integerValue));case"NULL":return E.Dr();default:return E.vr()}}}class z9 extends Uc{toTimestamp(e){if(!Mc(e))return E.vr();let t=Number(e/yn),r=Number(e%yn*BigInt(1e3));const i=Up(t,r);return t=i.seconds,r=i.nanos,Di(t,r)?E.newValue({timestampValue:{seconds:t,nanos:r}}):E.vr()}}class B9 extends Uc{toTimestamp(e){if(!function(a){return a>=L9&&a<=M9}(e))return E.vr();let t=Number(e/na),r=Number(e%na*BigInt(1e6));const i=Up(t,r);return t=i.seconds,r=i.nanos,Di(t,r)?E.newValue({timestampValue:{seconds:t,nanos:r}}):E.vr()}}class $9 extends Uc{toTimestamp(e){if(!Fp(e))return E.vr();const t=Number(e);return E.newValue({timestampValue:{seconds:t,nanos:0}})}}class zc{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length===1,1265,`${this.expr.name}() function should have exactly one parameter`);const r=K(this.expr.params[0]).evaluate(e,t);switch(r.type){case"TIMESTAMP":break;case"NULL":return E.Dr();default:return E.vr()}const i=Tc(r.value.timestampValue);return Di(i.seconds,i.nanoseconds)?this.$r(i):E.vr()}}class q9 extends zc{$r(e){const t=Fc(e);return Mc(t)?E.newValue({integerValue:`${t.toString()}`}):E.vr()}}class j9 extends zc{$r(e){const t=Fc(e),r=t/BigInt(1e3),i=t%BigInt(1e3);return r>BigInt(0)||i===BigInt(0)?E.newValue({integerValue:r.toString()}):E.newValue({integerValue:(r-BigInt(1)).toString()})}}class H9 extends zc{$r(e){const t=BigInt(e.seconds);return Fp(t)?E.newValue({integerValue:t.toString()}):E.vr()}}class zp{constructor(e){this.expr=e}evaluate(e,t){j(this.expr.params.length===3,2775,`${this.expr.name}() function should have exactly 3 parameters`);let r=!1;const i=K(this.expr.params[0]).evaluate(e,t);switch(i.type){case"TIMESTAMP":break;case"NULL":r=!0;break;default:return E.vr()}const s=K(this.expr.params[1]).evaluate(e,t);let a;switch(s.type){case"STRING":if(a=function(ce){switch(ce){case"microsecond":return"microsecond";case"millisecond":return"millisecond";case"second":return"second";case"minute":return"minute";case"hour":return"hour";case"day":return"day";default:return}}(s.value.stringValue),a===void 0)return E.vr();break;case"NULL":r=!0;break;default:return E.vr()}const c=K(this.expr.params[2]).evaluate(e,t);switch(c.type){case"INT":break;case"NULL":r=!0;break;default:return E.vr()}if(r)return E.Dr();const l=BigInt(c.value.integerValue);let h;try{switch(a){case"microsecond":h=l;break;case"millisecond":h=l*BigInt(1e3);break;case"second":h=l*BigInt(1e6);break;case"minute":h=l*BigInt(6e7);break;case"hour":h=l*BigInt(36e8);break;case"day":h=l*BigInt(864e8);break;default:return E.vr()}if(a!=="microsecond"&&l!==BigInt(0)&&h/l!==BigInt(this.Kr(a)))return E.vr()}catch(J){return It(`Error during timestamp arithmetic: ${J}`),E.vr()}const p=Tc(i.value.timestampValue);if(!Di(p.seconds,p.nanoseconds))return E.vr();const f=Fc(p),T=this.Wr(f,h);if(!Mc(T))return E.vr();const C=Number(T/yn),N=T%yn,L=Number((N<0?N+yn:N)*BigInt(1e3)),B=N<0?C-1:C;return Di(B,L)?E.newValue({timestampValue:{seconds:B,nanos:L}}):E.vr()}Kr(e){switch(e){case"millisecond":return 1e3;case"second":return 1e6;case"minute":return 6e7;case"hour":return 36e8;case"day":return 864e8;default:return 1}}}class G9 extends zp{Wr(e,t){return e+t}}class W9 extends zp{Wr(e,t){return e-t}}function Vi(n){if((n=Lp(n))instanceof Ki)return`fld(${n.fieldName})`;if(n instanceof Cr)return`cst(${function(t){return t===null?"null":typeof t=="number"?t.toString():typeof t=="string"?`"${t}"`:t instanceof Pe?`ref(${t.path})`:t instanceof tt?`vec(${JSON.stringify(t)})`:JSON.stringify(t)}(n.value)})`;if(n instanceof O)return`fn(${n.name},[${n.params.map(Vi).join(",")}])`;if(n.expressionType==="ListOfExpressions")return`list([${n.Rr.map(Vi).join(",")}])`;throw new Error(`Unrecognized expr ${JSON.stringify(n,null,2)}`)}function K9(n){if(n instanceof Op)return`${n._name}(${ws(n.fields)})`;if(n instanceof Dp){let e=`${n._name}(${ws(n.accumulators)})`;return n.groups.size>0&&(e+=`grouping(${ws(n.groups)})`),e}if(n instanceof Vp)return`${n._name}(${ws(n.groups)})`;if(n instanceof Aa)return`${n._name}(${n.Vr})`;if(n instanceof ba)return`${n._name}(${n.collectionId})`;if(n instanceof Cc)return`${n._name}()`;if(n instanceof Pc)return`${n._name}(${n.dr.sort()})`;if(n instanceof kc)return`${n._name}(${Vi(n.condition)})`;if(n instanceof ki)return`${n._name}(${n.limit})`;if(n instanceof Nc)return`${n._name}(${function(t){return t.map(r=>`${Vi(r.expr)}${r.direction}`).join(",")}(n.orderings)})`;throw new Error(`Unrecognized stage ${n._name}`)}function ws(n){return`${Array.from(n.entries()).sort().map(([e,t])=>`${e}=${Vi(t)}`).join(",")}`}function jt(n){return n.stages.map(e=>K9(e)).join("|")}function Bp(n,e){return jt(n)===jt(e)}function Ce(n){return n instanceof Ze}function $1(n){return Ce(n)?jt(n):ui(n)}function $p(n){return Ce(n)?jt(n):function(t){return`${ep(kt(t))}|lt:${t.limitType}`}(n)}function Ra(n,e){return n instanceof Ze&&e instanceof Ze?Bp(n,e):!(n instanceof Ze&&!(e instanceof Ze)||!(n instanceof Ze)&&e instanceof Ze)&&v4(n,e)}function qp(n){return Fn(n)?jt(n):ep(n)}function jp(n,e){return n instanceof Ze&&e instanceof Ze?Bp(n,e):!(n instanceof Ze&&!(e instanceof Ze)||!(n instanceof Ze)&&e instanceof Ze)&&tp(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function b5(n){n=_i(n,Pe);const e=_i(n.firestore,tl),t=u2(e);return m5(t,n._key).then(r=>R5(e,n,r))}function x5(n,e,t){n=_i(n,Pe);const r=_i(n.firestore,tl),i=I5(n.converter,e,t),s=m3(r);return S5(r,[y3(s,"setDoc",n._key,i,n.converter!==null,t).toMutation(n._key,qt.none())])}function S5(n,e){const t=u2(n);return y5(t,e)}function R5(n,e,t){const r=t.docs.get(e._key),i=new E5(n);return new qn(n,i,e._key,r,new ni(t.hasPendingWrites,t.fromCache),e.converter)}(function(e,t=!0){I7(Ar),Dt(new Et("firestore",(r,{instanceIdentifier:i,options:s})=>{const a=r.getProvider("app").getImmediate(),c=new tl(new x7(r.getProvider("auth-internal")),new C7(a,r.getProvider("app-check-internal")),Y7(a,i),a);return s={useFetchStreams:t,...s},c._setSettings(s),c},"PUBLIC").setMultipleInstances(!0)),gt(eh,th,e),gt(eh,th,"esm2020")})();const C5={apiKey:"AIzaSyABnvYQl4QzP1lHF4Ei_AzrDPYlMKoTXpA",authDomain:"yathralanka-2ac43.firebaseapp.com",projectId:"yathralanka-2ac43",storageBucket:"yathralanka-2ac43.firebasestorage.app",measurementId:"G-KXWXP8TGMS",appId:"1:1032179534120:web:21d200d59018319f7ca81d",messagingSenderId:"1032179534120"},nl=yh(C5);Y6(nl);const _n=h7(nl),d2=_5(nl);let w={currentScreen:"splash",user:{...To},activeSite:null,dwellTimer:null,dwellTimeLeft:900,dwellActive:!1,cooldownTimer:null,cooldownTimeLeft:300,cooldownActive:!1,cameraAttempt:1,currentQuizIndex:0,quizCorrectAnswers:0,quizAnswers:[],petitionSignatures:8742,petitionSigned:!1,donationAmount:0,navStack:[]};document.addEventListener("DOMContentLoaded",()=>{$("splash")});function $(n,e=!0){e&&w.currentScreen!==n&&w.navStack.push(w.currentScreen),w.currentScreen=n,ot()}function fe(){if(w.navStack.length>0){const n=w.navStack.pop();w.currentScreen=n,ot()}else $("dashboard")}function Ge(n,e=""){w.user.xp+=n;let t="None";G2.forEach(r=>{w.user.xp>=r.threshold&&(t=r.rank)}),w.user.rank!==t&&(w.user.rank=t,Xe(`New Rank Unlocked: ${t}!`)),e&&Xe(`${e} (+${n} XP)`),ri()}function ri(){const n=_n.currentUser;if(!n)return Promise.resolve();const e=Ap(d2,"users",n.uid);return x5(e,{xp:w.user.xp,rank:w.user.rank,medals:w.user.medals,sitesVisited:w.user.sitesVisited,quizzesPassed:w.user.quizzesPassed,role:w.user.role,interests:w.user.interests,permissions:w.user.permissions,signedPetitions:w.user.signedPetitions,donatedAmount:w.user.donatedAmount,joinedEvents:w.user.joinedEvents,unlockedCoupons:w.user.unlockedCoupons,completedQuizzes:w.user.completedQuizzes,dwellTimeCompleted:w.user.dwellTimeCompleted,verifiedPhotos:w.user.verifiedPhotos},{merge:!0}).catch(t=>console.error("Error saving user profile:",t))}function Xe(n){const e=document.createElement("div");e.style.cssText=`
    position: absolute;
    top: 60px;
    left: 20px;
    right: 20px;
  ...
  `}function O5(){const n=w.user.permissions.camera,e=w.user.permissions.notifications,t=n&&e;return`
    <div class="screen">
  ...
  `}function D5(){const n=w.user.role;return`
    <div class="screen dark-theme">
      <div class="header-bar">
  ...
  `}function V5(){const n=w.user.interests;return`
    <div class="screen">
  ...
  `}function M5(){return w.user.xp>0&&w.user.rank,`
    <div class="screen">
  ...
  `}function z5(){const n=w.activeSite;if(!n)return"";const e=w.user.dwellTimeCompleted[n.id];return`
  ...
  `}function B5(){const n=w.activeSite;if(!n)return"";const e=Math.floor(w.dwellTimeLeft/60),t=w.dwellTimeLeft%60,r=`${e<10?"0"+e:e}:${t<10?"0"+t:t}`,s=565.48-w.dwellTimeLeft/900*565.48,a=w.dwellTimeLeft<=0;return`
    <div class="screen">
      <div class="header-bar">
  ...
  `}function q5(){const n=w.activeSite;return`
  ...
  `}function W5(){const n=w.activeSite;if(!n)return"";const e=n.quizzes[w.currentQuizIndex],t=w.currentQuizIndex+1,r=n.quizzes.length;return`
    <div class="screen">
      <div class="header-bar">
  ...
  `}function K5(){const n=Math.floor(w.cooldownTimeLeft/60),e=w.cooldownTimeLeft%60,t=`${n<10?"0"+n:n}:${e<10?"0"+e:e}`;return`
    <div class="screen">
      <div class="header-bar">
  ...
  `}function ny(){const n=w.petitionSigned,e=w.petitionSignatures,t=e/1e4*100;return`
    <div class="screen" style="padding-bottom: 80px;">
      <div class="header-bar" style="position: absolute; top: 0; left: 0; z-index: 10; width: 100%;">
  ...
  `}function ry(){const n=w.donationAmount;return`
    <div class="screen" style="padding-bottom: 80px;">
      <div class="header-bar">
  ...
  `}function iy(){const n=w.user.joinedEvents.includes("site-cleanup");return`
    <div class="screen" style="padding-bottom: 80px;">
      <div class="header-bar">
  ...
  `}function uy(){let n=[...W2];if(w.user.xp>0){const e={name:(_n.currentUser&&_n.currentUser.displayName||"You")+" (Eco Explorer)",points:w.user.xp,role:w.user.role,rank:w.user.rank,isUser:!0};n.push(e)}return n.sort((e,t)=>t.points-e.points),`
    <div class="screen">
      <div class="header-bar">
  ...
  `}function hy(){const n=w.user.xp>0?w.user.rank:"No Rank";return`
    <div class="screen">
      <div style="padding: 20px 20px 6px 20px;">
  ...
  `}function fy(){const n=(f,T,C)=>{const N=document.getElementById(f);N&&N.addEventListener(T,C)};n("go-signin","click",()=>$("login")),n("go-signup","click",()=>$("signup")),n("login-back","click",()=>fe()),n("login-toggle-signup","click",()=>$("signup",!1)),n("login-submit","click",()=>{const f=document.getElementById("login-email").value,T=document.getElementById("login-pass").value;if(!f||!T){Xe("Please fill in all fields.");return}Xg(_n,f,T).then(C=>{const N=Ap(d2,"users",C.user.uid);return b5(N).then(L=>{if(w.user={...To},L.exists()){const B=L.data();w.user={...w.user,...B}}else w.user.role="Explorer";$("dashboard"),Xe("Welcome back, "+(C.user.displayName||"Explorer")+"!")})}).catch(C=>{Xe(C.message)})}),n("login-eye","click",()=>{const f=document.getElementById("login-pass");f&&(f.type=f.type==="password"?"text":"password")}),n("signup-back","click",()=>fe()),n("signup-toggle-login","click",()=>$("login",!1)),n("signup-submit","click",()=>{const f=document.querySelector("#signup-name").value.trim(),T=document.querySelector("#signup-user-email").value.trim(),C=document.querySelector("#signup-pass").value,N=document.querySelector("#signup-confirm").value;if(!f||!T||!C||!N){Xe("Please fill in all fields.");return}if(C!==N){Xe("Passwords do not match.");return}Qg(_n,T,C).then(L=>{try{alert("Auth Success! Attempting to navigate to permissions..."),$("permissions")}catch(B){alert("Navigation Failed Error: "+B.message)}}).catch(L=>{alert("Auth Error: "+L.message)})}),n("perm-camera-btn","click",()=>{w.user.permissions.camera=!w.user.permissions.camera,ot()}),n("perm-notif-btn","click",()=>{w.user.permissions.notifications=!w.user.permissions.notifications,ot()}),n("perm-continue","click",()=>{w.user.permissions.camera&&w.user.permissions.notifications&&(ri(),$("choose-role"))}),n("role-back","click",()=>fe()),document.querySelectorAll("[data-role]").forEach(f=>{f.addEventListener("click",()=>{w.user.role=f.getAttribute("data-role"),ot()})}),n("role-continue","click",()=>{w.user.role&&(ri(),$("calibrate-compass"))}),document.querySelectorAll("[data-cat]").forEach(f=>{f.addEventListener("click",()=>{const T=f.getAttribute("data-cat");w.user.interests.includes(T)?w.user.interests=w.user.interests.filter(C=>C!==T):w.user.interests.push(T),ot()})}),n("compass-continue","click",()=>{w.user.interests.length>0&&(ri(),$("how-scoring-works"))}),n("scoring-continue","click",()=>{ri(),$("dashboard"),Xe("Onboarding complete! Initial User state initialized.")}),n("dash-map-card","click",()=>$("map")),n("dash-search-card","click",()=>$("directory")),n("dash-view-directory","click",f=>{f.stopPropagation(),$("directory")}),n("directory-back","click",()=>$("dashboard")),n("tab-trail","click",()=>{document.getElementById("tab-trail").classList.add("active"),document.getElementById("tab-gems").classList.remove("active"),Ts("Heritage Trail")}),n("tab-gems","click",()=>{document.getElementById("tab-trail").classList.remove("active"),document.getElementById("tab-gems").classList.add("active"),Ts("Hidden Gems")});const r=document.getElementById("directory-search");if(r&&r.addEventListener("input",()=>{const f=document.querySelector(".tab-btn.active").id==="tab-trail"?"Heritage Trail":"Hidden Gems";Ts(f,r.value)}),w.currentScreen==="directory"){const f=document.querySelector(".tab-btn.active"),T=f&&f.id==="tab-gems"?"Hidden Gems":"Heritage Trail";Ts(T)}n("trail-list-back","click",()=>$("directory"));const i=document.getElementById("list-search-input");i&&i.addEventListener("input",()=>{const f=document.querySelector(".header-title").textContent;Eo(f,i.value)}),w.currentScreen==="heritage-trail"?Eo("Heritage Trail"):w.currentScreen==="hidden-gems"&&Eo("Hidden Gems"),n("map-back","click",()=>$("dashboard")),document.querySelectorAll(".map-pin").forEach(f=>{f.addEventListener("click",T=>{T.stopPropagation();const C=f.getAttribute("data-site-id"),N=fi.find(L=>L.id===C);N&&_y(N)})});const a=document.querySelector(".map-canvas");a&&a.addEventListener("click",()=>{const f=document.getElementById("map-popup-card");f&&f.remove()}),n("site-back","click",()=>fe()),n("site-visit-now","click",()=>{w.user.dwellTimeCompleted[w.activeSite.id]?$("camera"):(w.dwellTimeLeft=900,$("dwell-time"),gy())}),n("site-quiz-btn","click",()=>{w.user.dwellTimeCompleted[w.activeSite.id]&&(w.cooldownActive?$("quiz-cooldown"):(w.currentQuizIndex=0,w.quizCorrectAnswers=0,w.quizAnswers=[],$("quiz"),Yo()))}),n("site-quests-btn","click",()=>{w.user.dwellTimeCompleted[w.activeSite.id]&&$("quests")}),n("dwell-back","click",()=>{clearInterval(w.dwellTimer),w.dwellActive=!1,fe()});const c=document.getElementById("dwell-timer-clicker");c&&c.addEventListener("dblclick",()=>{clearInterval(w.dwellTimer),w.dwellTimeLeft=0,w.dwellActive=!1,w.user.dwellTimeCompleted[w.activeSite.id]=!0,w.user.sitesVisited=Object.keys(w.user.dwellTimeCompleted).length,Ge(50,`Presence verified at ${w.activeSite.name}!`),ot()}),n("dwell-continue-btn","click",()=>{w.dwellTimeLeft<=0&&$("camera")}),n("camera-back","click",()=>fe()),n("camera-shutter-click","click",()=>{w.cameraAttempt===1?(w.cameraAttempt=2,$("camera-reject")):$("camera-success")}),n("camera-success-continue","click",()=>{w.user.verifiedPhotos[w.activeSite.id]=!0,Ge(10,"Landmark photo verification success!"),$("site-detail")}),n("reject-close","click",()=>$("site-detail")),n("reject-guidelines","click",()=>$("guidelines")),n("reject-retry","click",()=>$("camera")),n("guidelines-back","click",()=>fe()),n("guidelines-continue","click",()=>$("camera")),n("sync-back","click",()=>fe()),n("quiz-back","click",()=>fe()),n("quiz-end-btn","click",()=>$("site-detail"));const l=document.querySelectorAll("#quiz-options-container .quiz-option-btn");l.forEach(f=>{f.addEventListener("click",()=>{const T=parseInt(f.getAttribute("data-index")),N=w.activeSite.quizzes[w.currentQuizIndex].correctIndex;l.forEach(L=>L.disabled=!0),w.quizAnswers.push(T),T===N?(f.classList.add("correct"),f.querySelector(".quiz-circle-ico").style.background="var(--color-green-success)",w.quizCorrectAnswers++):(f.classList.add("incorrect"),f.querySelector(".quiz-circle-ico").style.background="var(--color-red-reject)",l[N].classList.add("correct"),l[N].querySelector(".quiz-circle-ico").style.background="var(--color-green-success)"),setTimeout(()=>{if(w.currentQuizIndex+1<w.activeSite.quizzes.length)w.currentQuizIndex++,ot(),Yo();else{const L=w.quizCorrectAnswers,B=L*10;w.user.completedQuizzes[w.activeSite.id]=!0,w.user.quizzesPassed=Object.keys(w.user.completedQuizzes).length,Ge(B,`Quiz Complete! You got ${L}/5 correct.`),w.cooldownTimeLeft=300,$("quiz-cooldown"),p2()}},1500)})}),n("cooldown-back","click",()=>$("site-detail")),n("quests-back","click",()=>fe()),n("quest-item-social","click",()=>$("quest-social")),n("quest-item-local_food","click",()=>$("quest-food")),n("quest-item-wandering_around","click",()=>$("quest-wandering")),n("quest-item-wildlife_spotting","click",()=>$("quest-wildlife")),n("quest-item-eco_warrior","click",()=>$("quest-warrior")),n("quest-social-back","click",()=>fe()),n("quest-social-submit","click",()=>{document.getElementById("quest-social-link-input").value&&(Ge(5,"Social media post registered!"),$("quests"))}),n("quest-food-back","click",()=>fe()),n("quest-food-start","click",()=>{Ge(10,"Traditional recipe task completed!"),$("quests")}),n("quest-wandering-back","click",()=>fe()),n("quest-wandering-snap","click",()=>{Ge(60,"Rural landmark captured locally!"),$("quests")}),n("quest-wildlife-back","click",()=>fe()),n("quest-wildlife-snap","click",()=>{Ge(25,"Wildlife encounter successfully logged!"),$("quests")}),n("quest-warrior-back","click",()=>fe()),n("quest-warrior-snap","click",()=>{Ge(75,"Heritage reforestation planting logged!"),$("quests")}),n("act-link-petition","click",()=>$("petition")),n("act-link-donations","click",()=>$("donations")),n("act-link-cleanup","click",()=>$("cleanup")),n("act-link-create-event","click",()=>$("create-event")),n("petition-back","click",()=>fe()),n("petition-submit","click",()=>{w.petitionSigned||(w.petitionSigned=!0,w.petitionSignatures++,w.user.signedPetitions.push("ritigala-forest"),Ge(3,"You signed the Ritigala Protection Petition!"),ot())}),n("donations-back","click",()=>fe()),document.querySelectorAll(".donation-btn").forEach(f=>{f.addEventListener("click",()=>{const T=parseInt(f.getAttribute("data-val"));w.donationAmount=T,ot()})});const p=document.getElementById("donation-custom-input");p&&p.addEventListener("input",()=>{w.donationAmount=parseInt(p.value)||0}),n("donations-submit","click",()=>{if(w.donationAmount>0){w.user.donatedAmount+=w.donationAmount;const f=Math.min(15,Math.ceil(w.donationAmount/200));Ge(f,`Donated Rs. ${w.donationAmount} successfully!`),w.donationAmount=0,$("activism")}}),n("cleanup-back","click",()=>fe()),n("cleanup-join","click",()=>{w.user.joinedEvents.includes("site-cleanup")||(w.user.joinedEvents.push("site-cleanup"),Ge(15,"Registered for Elahera Anicut site cleanup!"),ot())}),n("create-event-back","click",()=>fe()),n("event-submit","click",()=>{const f=document.getElementById("event-location").value,T=document.getElementById("event-type").value;f&&(w.user.joinedEvents.push("community-event"),Ge(15,`Created Community event: ${T}!`),$("activism"))}),n("rew-link-list","click",()=>$("rewards-list")),n("rew-link-rank","click",()=>$("rank")),n("rew-link-leaderboard","click",()=>$("leaderboard")),n("rewards-list-back","click",()=>$("rewards")),n("rew-coupon-use","click",()=>$("coupon-redeem")),n("rew-unlock-guide","click",()=>{w.user.xp>=100&&(w.user.xp-=100,w.user.unlockedCoupons.push("guide"),Xe("Unlocked Ancient Trail Guide Coupon!"),$("rewards-list"))}),n("rew-unlock-crafts","click",()=>{w.user.xp>=100&&(w.user.xp-=100,w.user.unlockedCoupons.push("crafts"),Xe("Unlocked Artisan Crafts Coupon!"),$("rewards-list"))}),n("coupon-back","click",()=>fe()),n("coupon-redeem-btn","click",()=>{Xe("Voucher code validated. coupon redeemed!")}),n("coupon-review-submit","click",()=>{document.getElementById("coupon-review-input").value&&(Ge(10,"Review submitted successfully!"),document.getElementById("coupon-review-input").value="")}),n("rank-back","click",()=>fe()),n("leaderboard-back","click",()=>fe()),n("leaderboard-view-full","click",()=>{Xe("Rendering complete global leaderboard...")}),n("profile-recap-trigger","click",()=>$("travel-poster")),n("profile-travel-map","click",()=>$("travel-poster")),n("profile-settings","click",()=>$("settings")),n("poster-back","click",()=>fe()),n("settings-back","click",()=>fe()),n("sett-perm","click",()=>$("permissions")),n("sett-logout","click",()=>{em(_n).then(()=>{w.user={...To},w.user.permissions={camera:!1,notifications:!1},w.petitionSignatures=8742,w.petitionSigned=!1,w.navStack=[],$("splash"),Xe("Logged out successfully.")}).catch(f=>{Xe("Logout failed: "+f.message)})}),n("nav-home","click",()=>$("dashboard")),n("nav-act","click",()=>$("activism")),n("nav-rew","click",()=>$("rewards")),n("nav-prof","click",()=>$("profile"))}function gy(){w.dwellActive||(w.dwellActive=!0,w.dwellTimer=setInterval(()=>{w.dwellTimeLeft>0?(w.dwellTimeLeft--,w.currentScreen==="dwell-time"&&my()):(clearInterval(w.dwellTimer),w.dwellActive=!1,w.user.dwellTimeCompleted[w.activeSite.id]=!0,w.user.sitesVisited=Object.keys(w.user.dwellTimeCompleted).length,Ge(50,`Presence verified at ${w.activeSite.name}!`),w.currentScreen==="dwell-time"&&ot())},1e3))}function my(){const n=document.querySelector(".timer-text-display"),e=document.querySelector(".timer-progress-circle");if(!n||!e)return;const t=Math.floor(w.dwellTimeLeft/60),r=w.dwellTimeLeft%60;n.textContent=`${t<10?"0"+t:t}:${r<10?"0"+r:r}`;const s=565.48-w.dwellTimeLeft/900*565.48;e.style.strokeDashoffset=s}let Es=15,wo=null;function Yo(){clearInterval(wo),Es=15;const n=document.getElementById("quiz-timer");n&&(n.textContent="15s"),wo=setInterval(()=>{if(Es>0){Es--;const e=document.getElementById("quiz-timer");e&&(e.textContent=`${Es}s`)}else{clearInterval(wo);const e=document.querySelectorAll("#quiz-options-container .quiz-option-btn");e.forEach(r=>r.disabled=!0),w.quizAnswers.push(-1);const t=w.activeSite.quizzes[w.currentQuizIndex].correctIndex;e[t]&&(e[t].classList.add("correct"),e[t].querySelector(".quiz-circle-ico").style.background="var(--color-green-success)"),setTimeout(()=>{if(w.currentQuizIndex+1<w.activeSite.quizzes.length)w.currentQuizIndex++,ot(),Yo();else{const r=w.quizCorrectAnswers;w.user.completedQuizzes[w.activeSite.id]=!0,w.user.quizzesPassed=Object.keys(w.user.completedQuizzes).length,Ge(r*10,`Quiz Complete! You got ${r}/5 correct.`),w.cooldownTimeLeft=300,$("quiz-cooldown"),p2()}},1500)}},1e3)}function p2(){w.cooldownActive||(w.cooldownActive=!0,w.cooldownTimer=setInterval(()=>{w.cooldownTimeLeft>0?(w.cooldownTimeLeft--,w.currentScreen==="quiz-cooldown"&&yy()):(clearInterval(w.cooldownTimer),w.cooldownActive=!1,w.currentScreen==="quiz-cooldown"&&$("site-detail"))},1e3))}function yy(){const n=document.querySelector(".timer-text-display"),e=document.querySelector(".timer-progress-circle");if(!n||!e)return;const t=Math.floor(w.cooldownTimeLeft/60),r=w.cooldownTimeLeft%60;n.textContent=`${t<10?"0"+t:t}:${r<10?"0"+r:r}`;const s=565.48-w.cooldownTimeLeft/300*565.48;e.style.strokeDashoffset=s}function Ts(n,e=""){const t=document.getElementById("directory-grid-container");if(!t)return;const r=e.toLowerCase(),i=fi.filter(s=>{const a=s.category===n,c=s.name.toLowerCase().includes(r)||s.district.toLowerCase().includes(r);return a&&c});if(i.length===0){t.innerHTML='<div style="grid-column: 1/3; text-align: center; color: var(--color-gray); padding: 20px; font-size:12px;">No matching locations found</div>';return}t.innerHTML=i.map(s=>`
  ...
  `,t.appendChild(r),document.getElementById("map-popup-navigate-btn").addEventListener("click",i=>{i.stopPropagation(),w.activeSite=n,$("site-detail")}),r.addEventListener("click",i=>{i.stopPropagation(),w.activeSite=n,$("site-detail")})}
